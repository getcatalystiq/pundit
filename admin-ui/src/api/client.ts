...
// Text Memory
export const textMemory = {
  list: (databaseId: string) =>
    api.get<{ entries: TextMemoryEntry[] }>(`/admin/databases/${databaseId}/text-memory`),
  add: (databaseId: string, content: string) =>
    api.post<{ id: string }>(`/admin/databases/${databaseId}/text-memory`, { content }),
  delete: (databaseId: string, id: string) =>
    api.delete<{ deleted: boolean }>(`/admin/databases/${databaseId}/text-memory/${id}`),
};

// Tool Memory
export const toolMemory = {
  list: (databaseId: string) =>
    api.get<{ entries: ToolMemoryEntry[] }>(`/admin/databases/${databaseId}/tool-memory`),
  add: (databaseId: string, question: string, sql: string) =>
    api.post<{ id: string }>(`/admin/databases/${databaseId}/tool-memory`, { question, sql }),
  delete: (databaseId: string, id: string) =>
    api.delete<{ deleted: boolean }>(`/admin/databases/${databaseId}/tool-memory/${id}`),
};
